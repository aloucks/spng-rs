...
pub type spng_filter_choice = libc::c_uint;
...
pub type spng_encode_flags = libc::c_uint;
#[repr(C)]
...
pub type spng_location = libc::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type spng_option = libc::c_uint;
...
>;
pub type spng_write_fn = ::core::option::Option<
    unsafe extern "C" fn(
        ctx: *mut spng_ctx,
        user: *mut libc::c_void,
        src: *mut libc::c_void,
...
>;
pub type spng_rw_fn = ::core::option::Option<
    unsafe extern "C" fn(
        ctx: *mut spng_ctx,
        user: *mut libc::c_void,
        dst_src: *mut libc::c_void,
        length: usize,
    ) -> libc::c_int,
>;
extern "C" {
...
extern "C" {
    pub fn spng_decode_chunks(ctx: *mut spng_ctx) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn spng_encode_scanline(
        ctx: *mut spng_ctx,
        scanline: *const libc::c_void,
        len: usize,
    ) -> libc::c_int;
}
extern "C" {
    pub fn spng_encode_row(ctx: *mut spng_ctx, row: *const libc::c_void, len: usize)
        -> libc::c_int;
}
extern "C" {
    pub fn spng_encode_chunks(ctx: *mut spng_ctx) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn spng_get_gama_int(ctx: *mut spng_ctx, gama_int: *mut u32) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn spng_set_gama_int(ctx: *mut spng_ctx, gamma: u32) -> libc::c_int;
}
extern "C" {
